...
//                        .foliageColorOverride(0x59AE30)
    ...
    public static Biome sparseySpears(BootstrapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SPEARY_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SPEARY_FLOWER_PLACED_KEY);
    ...
    public static Biome pastelParcel(BootstrapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PASTEL_FLOWER_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WISTERIA_PLACED_KEY);
    ...
    public static Biome mushland(BootstrapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.MUSH_REEDS_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.MUSH_REEDS_WATER_PLACED_KEY);
...
//                        .grassColorOverride(0x7fdb3d)
    ...
    // lupine
    public static Biome lupineMeadow(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LUPINE_FILL_PLACED_KEY);
    ...
    public static Biome alpineRange(BootstrapContext<Biome> context) {
        ...
        // friendly reminder to not cause feature order cycle
        globalOverworldGeneration(biomeBuilder);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.BOULDER_PLACED_KEY);
    ...
    public static Biome steppedSprings(BootstrapContext<Biome> context) {
        ...
        // leaf bushes?
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SPRING_FLOWER_ALLIUM_PLACED_KEY);
    ...
    public static Biome satisForest(BootstrapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.ROCK_PLACED_KEY);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.ALIEN_PHYLLOSTACHYS_PATCH_PLACED_KEY);
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SATIS_FLOWER_PLACED_KEY);
