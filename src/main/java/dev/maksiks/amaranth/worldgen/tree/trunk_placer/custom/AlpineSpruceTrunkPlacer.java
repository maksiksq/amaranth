...
public class AlpineSpruceTrunkPlacer extends TrunkPlacer {
    public static final MapCodec<AlpineSpruceTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(
            p_70261_ -> trunkPlacerParts(p_70261_).apply(p_70261_, AlpineSpruceTrunkPlacer::new)
    );

    public AlpineSpruceTrunkPlacer(int baseHeight, int heightRandA, int heightRandB) {
        super(baseHeight, heightRandA, heightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.ALPINE_SPRUCE_TRUNK_PLACER.get();
    }
