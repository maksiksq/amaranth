 ...
 * @author Maksiks
 */
public class ShroomBoiAnimations {
    public static final AnimationDefinition ANIM_SHROOM_BOI_WALK = AnimationDefinition.Builder.withLength(0.3333F).looping()
            ...
            .addAnimation("hatahangie", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition ANIM_SHROOM_BOI_IDLE = AnimationDefinition.Builder.withLength(0.5F).looping()
            .addAnimation("hatahangie", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
