...
//
//    @SubscribeEvent
//    public static void onDrawBlockHighlight(ExtractBlockOutlineRenderStateEvent event) {
...
//
//
//    private static void drawCustomOutline(ExtractBlockOutlineRenderStateEvent event, BlockPos pos) {
