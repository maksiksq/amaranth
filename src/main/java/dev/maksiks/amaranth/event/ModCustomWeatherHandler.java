...
import dev.maksiks.amaranth.sound.MoodWindSoundInstance;
...
public class ModCustomWeatherHandler {
    ...
    private static MoodWindSoundInstance moodSound = null;
    ...
    private static void manageMoodSound(Minecraft mc, boolean inTargetBiome, boolean underground) {
        ...
        if (moodSound == null && ticksInBiome >= MOOD_SOUND_DELAY_TICKS) {
            moodSound = new MoodWindSoundInstance(ModSounds.ARCTIC_WIND_THRONGLED.get());
